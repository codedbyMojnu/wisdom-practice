export const wisdomCategories = [
    "দার্শনিক জ্ঞান (Philosophical Wisdom)",
    "ব্যবহারিক জ্ঞান (Practical Wisdom)",
    "আবেগীয় জ্ঞান (Emotional Wisdom)",
    "সামাজিক জ্ঞান (Social Wisdom)",
    "আধ্যাত্মিক জ্ঞান (Spiritual Wisdom)",
    "সাংস্কৃতিক জ্ঞান (Cultural Wisdom)",
    "বৈজ্ঞানিক ও প্রযুক্তিগত জ্ঞান (Scientific & Technical Wisdom)",
    "আর্থিক জ্ঞান (Financial Wisdom)",
